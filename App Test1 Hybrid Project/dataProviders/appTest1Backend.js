...
(function() {
    var provider = app.data.appTest1Backend = new Everlive({
            offlineStorage: true,
            apiKey: '2z6FrhsRwe8l6QWU',
    ...
    document.addEventListener('online', function() {
        app.data.appTest1Backend.offline(false);
        app.data.appTest1Backend.sync();
    });

    document.addEventListener('offline', function() {
        app.data.appTest1Backend.offline(true);
    });

}());

// START_CUSTOM_CODE_appTest1Backend
// END_CUSTOM_CODE_appTest1Backend